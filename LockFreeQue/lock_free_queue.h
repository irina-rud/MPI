//
// Created by riv on 16.05.16.
//

#ifndef LOCKFREEQUE_LOCK_FREE_QUEUE_H
#define LOCKFREEQUE_LOCK_FREE_QUEUE_H
...
private:
    ...
    void free_external_counter(lock_free_queue::counted_node_ptr &old_node_ptr) {
...
public:
    lock_free_queue(){
        head = (new std::atomic<counted_node_ptr>());
        tail = head.load();
    }
...
#endif //LOCKFREEQUE_LOCK_FREE_QUEUE_H
